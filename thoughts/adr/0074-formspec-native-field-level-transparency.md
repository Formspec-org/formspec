...
9. `specs/audit/respondent-ledger-spec.md` — class-aware `ChangeSetEntry` redaction, optional field-level editing changelog mode, and Privacy-Profile-gated value exposure rules.
