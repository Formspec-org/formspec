...
export type { AnyComponent, ChildrenArray, ComponentDocument, TargetDefinition, Breakpoints, Tokens, CustomComponentDef, StyleMap, AccessibilityBlock, ResponsiveOverrides, ComponentBase } from './component.js';
